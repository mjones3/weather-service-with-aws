...
public class WeatherApplication implements CommandLineRunner {
    ...
    public void setOpenWeatherMapReader(OpenWeatherMapReader openWeatherMapReader) {
        this.openWeatherMapReader = openWeatherMapReader;
    }
...
//	@Autowired
//	WeatherRecordsProcessor weatherRecordsProcessorService;

//	@PostConstruct
//	public void init() {
//		WeatherRecordProcessor.setProperties(weatherProperties);
...
//		weatherRecordsProcessorService.getWorker().run();


//		log.info(weatherProperties.toString());
//
//		this.region = Region.of(ObjectUtils.firstNonNull(weatherProperties.getKinesisRegionName()));
//
...
//		}
//
//		ConfigsBuilder configsBuilder = new ConfigsBuilder(weatherProperties.getStreamName(), weatherProperties.getApplicationName(), kinesisClient, dynamoClient, cloudWatchClient, UUID.randomUUID().toString(), new WeatherRecordProcessorFactory());
//
//		/**
...
//				configsBuilder.retrievalConfig().retrievalSpecificConfig(new PollingConfig(weatherProperties.getStreamName(), kinesisClient))
//		);
//
//		/**
...
//				.streamName(weatherProperties.getStreamName())
...
//
//		private static void setProperties(WeatherProperties weatherProperties) {
//			WeatherRecordProcessor.weatherProperties = weatherProperties;
//		}
//
...
//
//				processRecordsInput.records().forEach(r -> writeToS3(openWeatherMapReader.getWeatherData(getWeatherRequest(r).getZip()), weatherProperties.getBucketName()));
//
//			} catch (Throwable t) {
//
